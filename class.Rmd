...
ggplot(data=x, mapping = aes(x=mean_age)) +
  geom_histogram(bins=20)+  labs(title="Distribution of Mean Age in Kenya", x="Mean Age", y="Count")+
  xlim(33,50)
...
ggplot(data=x, mapping = aes(x=reg_inc)) +
  geom_histogram()+  labs(title="Distribution of Increase in Registered Voters in Kenya", x="Increase in Voter Registration", y="Count")+
scale_x_log10()
```
